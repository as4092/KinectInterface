 ...
 */
 ...
 //FOR TOMORROW:
 //Hook it back up the Living Room, start fixing those bugs
 //Add sound effects?
...
void draw()
{
  ...
  for (i=1; i<=10; i++)
  {
    ...
    if (context.isTrackingSkeleton(i))
    {
      ...
      //CURRENTLY THIS JUST GRABS THE MOST RECENT USERS, GONNA WANT TO HAVE A DIFFERENT SET OF JOINTS FOR EACH USER
      setJoints(i);
    }
  ...
  int incrementor=2;
  //Would be helpful if I was doing it via curvature, but I'm not
  //if(bBoxRight!=null && bBoxLeft!=null){
  //  incrementor=1;
 // }
  drawDepthHands(incrementor);
  popMatrix();
  ...
  if(bBoxRight!=null){
    ...
    if(right!=null){
      ...
      frameRight.s.thumb = rightThumb;
      
    }
  }
  
  
  if(bBoxLeft!=null && leftHand!=null){
